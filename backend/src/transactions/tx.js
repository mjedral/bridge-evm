...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var CONTRACT_PATHS, besu_provider, key, besuProvider, besuWallet, besuToken;
        return __generator(this, function (_a) {
            ...
            besu_provider = process.env.PROVIDER_BESU;
            ...
            besuToken = new ethers.Contract('0x43ca3D2C94be00692D207C6A1e60D8B325c6f12f', (0, helpers_1.getAbiFromJsonFile)(CONTRACT_PATHS.SourceToken), besuWallet);
            return [2 /*return*/];
        });
    });
}

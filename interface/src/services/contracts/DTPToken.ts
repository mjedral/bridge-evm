...
import { DTP_Token } from '../../../../simple-dex-contracts/typechain-types/contracts/DTP_Token/DTP_Token';
...
import { DTP_Token__factory } from '../../../../simple-dex-contracts/typechain-types/factories/contracts/DTP_Token/DTP_Token__factory';
...
const getTokenContract = (library: Web3Library | undefined): DTP_Token | undefined => {
  if (library) {
    return DTP_Token__factory.connect('0x8b05Fe368F34a9D401bdCE44D2ed82E5769bfD72', library);
  }
};
